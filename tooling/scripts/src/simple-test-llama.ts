...
async function simpleTest() {
	...
	try {
		const text = await generateText(
			"llama3.2:latest",
			"Hello! Say 'Hello from Llama!' and tell me a fun fact about AI.",
		);
		...
		console.log(text);
		console.log("-".repeat(40));
		console.log("\n🎉 Llama AI package is working correctly!");
	} catch (error: any) {
	...
	const productPrompt = prompts.promptListProductNames("smart coffee mug");
