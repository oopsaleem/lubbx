	...
	<SelectPrimitive.Portal>
		<SelectPrimitive.Content
			...
			className={cn(
				...
				position === "popper"
					? "data-[side=left]:-translate-x-1 rtl:data-[side=left]:translate-x-1 data-[side=top]:-translate-y-1 data-[side=right]:translate-x-1 rtl:data-[side=right]:-translate-x-1 data-[side=bottom]:translate-y-1"
					: "",
				className,
			)}
			position={position}
